...
namespace EmployeePayRollADONet
{
    public class EmployeeRepository
    {
        ...
        public void UpdateSalary()
        {
            //Open Connection
            sqlConnection.Open();
            string query = "update employee_payroll set basicPay=3670000 where name= 'sanay'";
            //Pass query to TSql
            SqlCommand sqlCommand = new SqlCommand(query, sqlConnection);
        ...
        public string DataBasedOnDateRange()
        {
            ...
            try
            {
                ...
                {
                    //query execution
                    string query = @"select * from employee_payroll where startDate BETWEEN Cast('2019-08-19' as Date) and GetDate();";
